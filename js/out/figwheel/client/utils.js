...
var f = (function (){var pred__32063 = cljs.core._EQ_;
var expr__32064 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32063.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32064))){
return (function (p1__32057_SHARP_){
return console.warn(p1__32057_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32063.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32064))){
return (function (p1__32058_SHARP_){
return console.debug(p1__32058_SHARP_);
});
} else {
if(cljs.core.truth_(pred__32063.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32064))){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32067){
var map__32068 = p__32067;
var map__32068__$1 = (((((!((map__32068 == null))))?(((((map__32068.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32068.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32068):map__32068);
var opts = map__32068__$1;
var eval_fn = cljs.core.get.call(null,map__32068__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__32070_SHARP_){
return new_def.callback(p1__32070_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__32071){
var vec__32072 = p__32071;
var ky = cljs.core.nth.call(null,vec__32072,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1585778617631
