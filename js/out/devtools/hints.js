...
var file = cljs.core.get.call(null,map__46018__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__46018__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__46018__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e46017){var _e = e46017;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___46020 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___46020)){
var seen_errors_46021 = temp__5733__auto___46020;
if(cljs.core.truth_(seen_errors_46021.has(self))){
} else {
seen_errors_46021.add(self);

var temp__5735__auto___46022 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___46022)){
var sense_46023 = temp__5735__auto___46022;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46023)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1585778478507
