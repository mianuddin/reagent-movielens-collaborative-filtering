...
var o43792 = temp__5733__auto__;
var temp__5733__auto____$1 = (o43792["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o43793 = temp__5733__auto____$1;
return (o43793["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28997__auto__ = f;
return (o__28997__auto__["toString"]).call(o__28997__auto__);
} else {
return "";
}
}catch (e43794){var _ = e43794;
return "";
}});
...
try{var o__28997__auto___43796 = t;
(o__28997__auto___43796["cljs$lang$ctorPrWriter"]).call(o__28997__auto___43796,t,writer);
}catch (e43795){var __43797 = e43795;
}
...
var char_code = (function (){var o__28997__auto__ = (new String(char$));
return (o__28997__auto__["charCodeAt"]).call(o__28997__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28997__auto__ = String;
return (o__28997__auto__["fromCharCode"]).call(o__28997__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__43798 = num_code;
switch (G__43798) {
case (1):
return (185);
...
var o__28997__auto__ = String;
return (o__28997__auto__["fromCharCode"]).call(o__28997__auto__,superscript_code);
});
/**
...
}catch (e43800){var _e__29004__auto__ = e43800;
return false;
}})())){
...
var vec__43801 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__43801,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o43804 = temp__5733__auto__;
var temp__5733__auto____$1 = (o43804["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o43805 = temp__5733__auto____$1;
return (o43805["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__43808){
var vec__43809 = p__43808;
var ns_detector = cljs.core.nth.call(null,vec__43809,(0),null);
...
var G__43815 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__43816 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__43815;
remaining_tokens = G__43816;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq43806){
var G__43807 = cljs.core.first.call(null,seq43806);
var seq43806__$1 = cljs.core.next.call(null,seq43806);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43807,seq43806__$1);
}));
...
var vec__43820 = cljs.core.split_with.call(null,(function (p1__43819_SHARP_){
return cljs.core.not_EQ_.call(null,p1__43819_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__43820,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__43820,(1),null);
...
var vec__43826 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__43826,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__43826,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__43829 = cljs.core.rest.call(null,remaining_tokens);
var G__43830 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__43829;
name_tokens = G__43830;
continue;
} else {
...
var vec__43833 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__43833,(0),null);
var arity = cljs.core.nth.call(null,vec__43833,(1),null);
var vec__43836 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__43836,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__43836,(1),null);
var vec__43839 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__43839,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__43839,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__43839,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__43839,(3),null);
...
var vec__43845 = result;
var munged_ns = cljs.core.nth.call(null,vec__43845,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__43845,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__43845,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__43845,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__43845,(4),null);
var arity = cljs.core.nth.call(null,vec__43845,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__43849 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__43849,(0),null);
var args = cljs.core.nth.call(null,vec__43849,(1),null);
var vec__43852 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__43852,(0),null);
var name = cljs.core.nth.call(null,vec__43852,(1),null);
...
var G__43855 = (arity + (1));
var G__43856 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__43857){
var vec__43858 = p__43857;
var arity = cljs.core.nth.call(null,vec__43858,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__43858,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__43861_SHARP_){
return cljs.core.get.call(null,arities,p1__43861_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__43862_SHARP_){
return cljs.core.drop.call(null,(2),p1__43862_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__43865){
var vec__43866 = p__43865;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__43866,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq43863){
var G__43864 = cljs.core.first.call(null,seq43863);
var seq43863__$1 = cljs.core.next.call(null,seq43863);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43864,seq43863__$1);
}));
...
var map__43874 = options;
var map__43874__$1 = (((((!((map__43874 == null))))?(((((map__43874.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43874.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43874):map__43874);
var include_ns_QMARK_ = cljs.core.get.call(null,map__43874__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__43874__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__43874__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__43874__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__43875 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__43875,(0),null);
var fn_name = cljs.core.nth.call(null,vec__43875,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__43875,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__43875,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__43875,(4),null);
var arity = cljs.core.nth.call(null,vec__43875,(5),null);
...
var o__28997__auto__ = f;
return (o__28997__auto__["getBasis"]).call(o__28997__auto__);
});
/**
...
}catch (e43879){var _e__29004__auto__ = e43879;
...
var G__43880 = (obj[cljs.core.first.call(null,path)]);
var G__43881 = cljs.core.rest.call(null,path);
obj = G__43880;
path = G__43881;
continue;
} else {
...
var _STAR_ = (function (accum,p__43882){
var vec__43883 = p__43882;
var bit = cljs.core.nth.call(null,vec__43883,(0),null);
var protocol = cljs.core.nth.call(null,vec__43883,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43886){
var vec__43887 = p__43886;
var ns = cljs.core.nth.call(null,vec__43887,(0),null);
var name = cljs.core.nth.call(null,vec__43887,(1),null);
var selector = cljs.core.nth.call(null,vec__43887,(2),null);
...
var post_process = (function (p__43891){
var vec__43892 = p__43891;
var munged_name = cljs.core.nth.call(null,vec__43892,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__43892,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__43890_SHARP_){
return (obj[cljs.core.first.call(null,p1__43890_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1585778471353
