...
goog.addDependency("../public/js/npm_packages_bundle.js", ['react', 'react_dom', 'react_loading_skeleton', 'dataframe_js'], [], {'foreign-lib': true});
...
goog.addDependency("../reagent_movielens_collaborative_filtering/components/search.js", ['reagent_movielens_collaborative_filtering.components.search'], ['clj_fuzzy.metrics', 'reagent.core', 'cljs.core', 'clojure.string']);
goog.addDependency("../reagent_movielens_collaborative_filtering/helpers/cf.js", ['reagent_movielens_collaborative_filtering.helpers.cf'], ['cljs.core', 'clojure.set']);
goog.addDependency("../reagent_movielens_collaborative_filtering/components/rating.js", ['reagent_movielens_collaborative_filtering.components.rating'], ['cljs.core']);
goog.addDependency("../reagent_movielens_collaborative_filtering/components/movie_prompt.js", ['reagent_movielens_collaborative_filtering.components.movie_prompt'], ['reagent_movielens_collaborative_filtering.components.rating', 'cljs.core']);
goog.addDependency("../reagent_movielens_collaborative_filtering/components/survey.js", ['reagent_movielens_collaborative_filtering.components.survey'], ['reagent.core', 'cljs.core', 'reagent_movielens_collaborative_filtering.components.movie_prompt', 'react_loading_skeleton']);
goog.addDependency("../reagent_movielens_collaborative_filtering/components/explainer.js", ['reagent_movielens_collaborative_filtering.components.explainer'], ['dataframe_js', 'cljs.core', 'reagent_movielens_collaborative_filtering.helpers.cf', 'react_loading_skeleton']);
goog.addDependency("../reagent_movielens_collaborative_filtering/core.js", ['reagent_movielens_collaborative_filtering.core'], ['dataframe_js', 'reagent.core', 'reagent_movielens_collaborative_filtering.components.search', 'cljs.core', 'reagent_movielens_collaborative_filtering.helpers.cf', 'reagent_movielens_collaborative_filtering.components.survey', 'reagent.dom', 'reagent_movielens_collaborative_filtering.components.explainer']);
goog.addDependency("../reagent_movielens_collaborative_filtering/dev.js", ['reagent_movielens_collaborative_filtering.dev'], ['cljs.core', 'devtools.core', 'reagent_movielens_collaborative_filtering.core']);
